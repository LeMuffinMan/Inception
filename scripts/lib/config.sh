...
CREDENTIALS_FILES=("wp_user.txt" "wp_admin_user.txt" "mysql_user_email.txt" "mysql_user.txt" "mysql_admin_email.txt" "db_password.txt" "db_root_password.txt" "wp_admin_password.txt" "wp_user_password.txt" "ftp_pass.txt")
